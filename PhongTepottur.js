...
var modelViewMatrixLoc, projectionMatrixLoc, normalMatrixLoc, usePhongLoc;
var normalMatrix;
var eye;
...
window.onload = function init() {
  ...
  gl.uniform1i(usePhongLoc, usePhongState);
  var btn = document.getElementById("changeState");
  btn.addEventListener("click", function () {
    usePhongState = 1 - usePhongState;
    gl.uniform1i(usePhongLoc, usePhongState);
    btn.textContent = usePhongState ? "Phong" : "Blinn-Phong";
  });
